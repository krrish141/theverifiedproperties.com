      ...
      .then((response) => {
        ...
        if (response.data && Array.isArray(response.data.data)) {
          ...
          const filteredData = response.data.data.filter(
            (post) => post.CategoryId === "2" && post.SubCategoryId === "12"
          );
    ...
    <>
      ...
      <div className="page-banner-section section">
        <div className="container">
          <div className="row">
            <div className="col">
              <h1 className="page-banner-title">Rent - Bungalow</h1>
              <ul className="page-breadcrumb">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li className="active">Rent Bungalow</li>
              </ul>
            </div>
          </div>
        </div>
