...
const Rent = () => {
  ...
  useEffect(() => {
    axios
      .get("https://theverifiedproperties.com/the-verified-properties-admin/api/get_property.php") // Use correct API URL
      .then((response) => {
        ...
        if (Array.isArray(response.data)) {
          ...
          // If data is wrapped in an object with a 'data' key
          const filteredData = response.data.data
            .filter((post) => post.CategoryId === "2")
            .sort((a, b) => b.PostId - a.PostId); // Sort in descending order based on PostId
    ...
    <>
      ...
      <div className="page-banner-section section">
        <div className="container">
          <div className="row">
            <div className="col">
              <h1 className="page-banner-title">Rent Properties</h1>
              <ul className="page-breadcrumb">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li className="active">Rent Properties</li>
              </ul>
            </div>
          </div>
        </div>
                        ...
                        <div key={PostUrl}>
                          <div className="property-inner mb-40">
                            ...
                            <div className="content">
                              ...
                              <Link to={`/properties_detail?slug=${PostUrl}`} className="read-more">
                                View Property
                              </Link>
                            </div>
                          </div>
