      ...
      .then((response) => {
        ...
        if (response.data && Array.isArray(response.data.data)) {
          ...
          const filteredData = response.data.data.filter(
            (post) => post.CategoryId === "1" && post.SubCategoryId === "8"
          );
    ...
    <>
      ...
      <div className="page-banner-section section">
        <div className="container">
          <div className="row">
            <div className="col">
              <h1 className="page-banner-title">Sell - Bungalow</h1>
              <ul className="page-breadcrumb">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li className="active">Sell Bungalow</li>
              </ul>
            </div>
          </div>
        </div>
